...
CREATE TABLE `trophee` (
  ...
  CONSTRAINT `trophee_ibfk_1` FOREIGN KEY (`num_preneur`) REFERENCES `habitant` (`num_hab`),
  CONSTRAINT `trophee_ibfk_2` FOREIGN KEY (`num_resserre`) REFERENCES `resserre` (`num_resserre`),
  CONSTRAINT `trophee_ibfk_3` FOREIGN KEY (`code_cat`) REFERENCES `categorie` (`code_cat`)
...
INSERT INTO `trophee` VALUES (11,'2052-04-03 00:00:00','BLE',7,3),(12,'2052-04-03 00:00:00','BLT',11,3),(13,'2052-05-05 00:00:00','CDN',15,1),(14,'2052-05-05 00:00:00','CLE',16,2),(15,'2052-06-06 00:00:00','CCN',16,2),(16,'2052-06-06 00:00:00','BLT',8,1),(17,'2052-08-18 00:00:00','CCN',8,1),(18,'2052-09-20 00:00:00','CLT',1,3),(19,'2052-10-23 00:00:00','CDN',7,2),(20,'2052-10-23 00:00:00','CLE',16,1);
...
-- Dump completed on 2021-02-22 13:14:11
